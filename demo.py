...
net = VNet(size)
save_dir = 'output/'
net.load_state_dict(torch.load(save_dir + 'model.pth')) # need to fix so that we read dict correctly (VNet methods are different, override load_state_dict)

# Save filenames - output and save?
