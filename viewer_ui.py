...
from data import MotionCorrDataset, GenericFilenames, TransposeBack
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, test_dataset, pred_dataset):
        ...
        self.corrupt = None # H x W x D x C
        self.truth = None # H x W x D x C
        self.pred = None # B x C x H x W x D
        self.loss = None # 1
